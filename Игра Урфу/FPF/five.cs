...
namespace FivePlusFive
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if (sum % 2560 == 0) pics[k, j].BackColor = Color.Red;
            else if (sum % 1280 == 0) pics[k, j].BackColor = Color.Green;
            else if (sum % 640 == 0) pics[k, j].BackColor = Color.Brown;
            else if (sum % 320 == 0) pics[k, j].BackColor = Color.Blue;
            else if (sum % 160 == 0) pics[k, j].BackColor = Color.Purple;
            else if (sum % 80 == 0) pics[k, j].BackColor = Color.Yellow;
            else if (sum % 40 == 0) pics[k, j].BackColor = Color.Cyan;
            else if (sum % 20 == 0) pics[k, j].BackColor = Color.Indigo;
            else pics[k, j].BackColor = Color.White;
        }
